 ...
 * @OA\POST(
 *     path="/api/installations/{installation_id}/reservations",
 ...
 *     @OA\Parameter(in="path", name="installation_id", required=false, @OA\Schema(type="string")
 * ),
