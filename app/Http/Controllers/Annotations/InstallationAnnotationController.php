 ...
 * @OA\PUT(
 *     path="/api/installations/{id}/disponible",
 ...
 * @OA\PUT(
 *     path="/api/installations/{id}/indisponible",
 ...
 *                     @OA\Property(property="prix_par_heure", type="string"),
 *                     @OA\Property(property="disponible", type="string"),
 ...
 * @OA\Response(response="403", description="Forbidden"),
 * @OA\Response(response="404", description="Not Found"),
 *     @OA\Parameter(in="path", name="installation", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="header", name="User-Agent", required=false, @OA\Schema(type="string")
 * ),
 *     tags={"Installation"},
 ...
 * @OA\GET(
 *     path="/api/installations/disponibles",
...
*/
 ...
 class InstallationAnnotationController {}
